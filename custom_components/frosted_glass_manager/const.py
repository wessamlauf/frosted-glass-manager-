...
# Default values (Tvoja pôvodná téma)
DEFAULT_LIGHT_PRIMARY = [106, 116, 211]
DEFAULT_LIGHT_TEXT = [19, 21, 54]         # <--- VRÁTENÉ (Potrebné pre generovanie)
...
DEFAULT_DARK_TEXT = [234, 235, 238]       # <--- VRÁTENÉ (Potrebné pre generovanie)
...
# Tvoja FULL 1:1 Šablóna (Nezmenená)
THEME_TEMPLATE = """
